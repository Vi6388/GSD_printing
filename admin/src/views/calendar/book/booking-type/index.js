        ...
        <Card>
          <CardBody>
            ...
            <div className="d-flex border-bottom pb-50 mb-1">
              <Link to={`/book/add/${bookingType.link}`} className="role-edit-modal">
            ...
            <div className="d-flex align-items-center">
              <div className="form-switch">
                <Input
                  ...
                  defaultChecked={bookingType.status}
                  id={`booking-switch-${bookingType._id}`}
                  name="booking-switch"
                />
              ...
              <Label
                ...
                for={`booking-switch-${bookingType._id}`}
              >
