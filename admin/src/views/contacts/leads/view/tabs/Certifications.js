...
const data = [
  ...
  },
  {
    ...
    imgSrc: require('@src/assets/images/icons/certifications/ceh.png').default
  },
  {
    cardCvc: '3845',
    expiryDate: '08/20',
    ...
    imgSrc: require('@src/assets/images/icons/certifications/cism.png').default
  }
];
                ...
                >
                  <div className="d-flex justify-content-between flex-sm-row flex-column">
                    ...
                    <div className="d-flex flex-column text-start text-lg-end">
                      ...
                      <span className="mt-2">Got Certificate at {card.expiryDate}</span>
                    </div>
                  </div>
                </div>
              );
            ...
            <Col xs={12}>
              <div className="mb-1">
                ...
                <Controller
                  name="company"
                  control={control}
                  render={() => <Input id="company" placeholder="Certified By" />}
                />
              </div>
              <div className="mb-1">
                <Label className="form-label" for="credit-card">
