            ...
            {state !== null ? (
              <ul className="list-unstyled">
                ...
                <li className="mb-75">
                  <span className="fw-bolder me-25">Address:</span>
                  <span>
                    {state?.companyAddress?.zipCode} {state?.companyAddress?.street}{' '}
                    {state?.companyAddress?.state} {state?.companyAddress?.city}{' '}
                  </span>
                </li>
              </ul>
            ) : null}
            ...
            <Row className="gy-1 pt-75">
              ...
              <Col md={6} xs={12}>
                ...
                <Select
                  ...
                  theme={selectThemeColors}
                  defaultValue={
                    stageOptions[stageOptions.findIndex((i) => i.value === selectedUser.status)]
                  }
                />
              </Col>
