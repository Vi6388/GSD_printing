...
// ** File Section
export const fileAddReqeust = (payload) => API.post(`/lead-contact/file-add`, payload);

export const fileDeleteReqeust = (payload) => API.post(`/lead-contact/file-delete`, payload);
...
export const otherDeleteReqeust = (payload) => API.post(`/lead-contact/delete/other`, payload);

export const uploadAvatarReqeust = (payload) => API.post(`/lead-contact/upload-avatar`, payload);

export const deleteContact = (payload) => API.post(`/lead-contact/delete-contact`, payload);
