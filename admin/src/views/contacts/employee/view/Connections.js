    ...
    if (selectedUser) {
      ...
      if (selectedUser.socialLinks) {
        setSocialLinks((p) => {
          let newLinks = [];
          for (let each of p) {
            const find = Array.from(selectedUser.socialLinks).find((x) => x?.name === each?.name);
            if (find) {
              each.link = find?.link;
            }
            newLinks.push(each);
            ...
            return (
              <div key={index} className="d-flex mt-2">
                ...
                <div className="d-flex align-item-center justify-content-between flex-grow-1">
                  <div className="me-1">
                    <p className="fw-bolder mb-0">{item?.name}</p>
                  </div>
              ...
              <ModalBody>
                <Row>
                  <Col sm="12" className="mb-1">
                    ...
                    <Input
                      value={socialLinks.find((x) => x.name === 'facebook')?.link}
                      onChange={(e) => handleOnchangeLink(e, 'facebook')}
                      type="text"
                      id="input-default"
                  ...
                  <Col sm="12" className="mb-1">
                    ...
                    <Input
                      value={socialLinks.find((x) => x.name === 'instagram')?.link}
                      onChange={(e) => handleOnchangeLink(e, 'instagram')}
                      type="text"
                      id="input-default"
                      placeholder="Paste the link here ..."
                    />
                  ...
                  <Col sm="12" className="mb-1">
                    ...
                    <Input
                      value={socialLinks.find((x) => x.name === 'twitter')?.link}
                      onChange={(e) => handleOnchangeLink(e, 'twitter')}
                      type="text"
                      id="input-default"
                      placeholder="Paste the link here ..."
                    />
                  ...
                  <Col sm="12" className="mb-1">
                    ...
                    <Input
                      value={socialLinks.find((x) => x.name === 'linkedin')?.link}
                      onChange={(e) => handleOnchangeLink(e, 'linkedin')}
                      type="text"
                      id="input-default"
                      placeholder="Paste the link here ..."
                    />
                  ...
                  <Col sm="12" className="mb-1">
                    ...
                    <Input
                      value={socialLinks.find((x) => x.name === 'dribble')?.link}
                      onChange={(e) => handleOnchangeLink(e, 'dribble')}
                      type="text"
                      id="input-default"
                      placeholder="Paste the link here ..."
                    />
                  ...
                  <Col sm="12" className="mb-1">
                    ...
                    <Input
                      value={socialLinks.find((x) => x.name === 'behance')?.link}
                      onChange={(e) => handleOnchangeLink(e, 'behance')}
                      type="text"
                      id="input-default"
                      placeholder="Paste the link here ..."
                    />
