...
const BillingAddress = () => {
  ...
  const { billingAddressUpdate } = useSelector((state) => state.employeeContact);
    ...
    <Fragment>
          ...
          <Row>
            <Col xl="7" xs="12">
              <Row tag="dl" className="mb-0">
                ...
                <Col tag="dd" sm="8" className="mb-1">
                  {contact?.data?.billingAddress?.addressLineOne}
                  {contact?.data?.billingAddress?.addressLineTwo}{' '}
                  {contact?.data?.billingAddress?.street} {contact?.data?.billingAddress?.city}{' '}
                  {contact?.data?.billingAddress?.state} {contact?.data?.billingAddress?.country}
                </Col>
              </Row>
            </Col>
            <Col xl="5" xs="12">
      ...
      >
        ...
        <ModalBody className="pb-5 px-sm-4 mx-50">
          <h1 className="address-title text-center mb-1">Update Billing Address</h1>
