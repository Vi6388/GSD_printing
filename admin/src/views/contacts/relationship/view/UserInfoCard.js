...
import { updateContactAction, uploadAvatarAction, getSingleConactAction } from '../store/actions';
    ...
    <Fragment>
      ...
      <Card>
        <CardBody>
          ...
          <h4 className="fw-bolder border-bottom pb-50 mb-1">lead Info</h4>
            ...
            {selectedUser !== null ? (
              <ul className="list-unstyled">
                ...
                <li className="mb-75">
                  ...
                  <span>
                    {state?.address?.zipCode} {state?.address?.street} {state?.address?.city}{' '}
          ...
          <div className="info-container">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-75">
                <span className="fw-bolder me-25">Address:</span>
                <span>
                  {selectedUser?.companyAddress?.zipCode} {selectedUser?.companyAddress?.street}{' '}
                  {selectedUser?.companyAddress?.state} {selectedUser?.companyAddress?.city}{' '}
                </span>
              </li>
            </ul>
            {/* // ) : null} */}
      ...
      <Modal isOpen={show} toggle={() => setShow(!show)} className="modal-dialog-centered modal-lg">
        ...
        <ModalBody className="px-sm-5 pt-50 pb-5">
          <div className="text-center mb-2">
            ...
            <p>Updating leads details will receive a privacy audit.</p>
          </div>
          <Form onSubmit={handleSubmit(onSubmit)}>
            <Row className="gy-1 pt-75">
              <h4 className="fw-bolder border-bottom pb-50 mb-1">Leads Info</h4>
              <Col md={6} xs={12}>
