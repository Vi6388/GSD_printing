        ...
        <div className="m-1">
          <Card className="mb-3">
            ...
            <CardBody>
              ...
              <CardText>
                <small className="text-muted">Complete sub goals one by one</small>
              </CardText>
              <Button
        ...
        <div className="m-1">
          <Card className="mb-3">
            ...
            <CardBody>
              ...
              <CardText>
                <small className="text-muted">Mark your daily achievement</small>
              </CardText>
              <Button
        ...
        <div className="m-1">
          <Card className="mb-3">
            ...
            <CardBody>
              ...
              <CardText>
                <small className="text-muted">Drag and Drop to update your progress</small>
              </CardText>
              <Button
