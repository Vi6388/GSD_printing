    ...
    <div className="todo-app-list">
      <div className="ps-1 bg-white d-flex align-items-center border-bottom">
        ...
        <div className="d-flex align-items-center">
          <Button color="flat-primary" onClick={() => setNewGoalModal(!newGoalModal)}>
            <Plus size={14} />
            <span className="align-middle ms-25">Create New Goal</span>
          </Button>
        ...
        <Modal
          ...
          size="lg"
        >
          <ModalHeader toggle={() => setNewGoalModal(!newGoalModal)}>Create A New Goal</ModalHeader>
          <ModalBody>
            <NewGoalWizard />
          </ModalBody>
        </Modal>
      ...
      <div className="app-fixed-search d-flex align-items-center">
        ...
        <div className="d-flex align-content-center justify-content-between w-100">
          <InputGroup className="input-group-merge">
            ...
            <Input placeholder="Search goal" value={query} onChange={handleFilter} />
          </InputGroup>
        </div>
