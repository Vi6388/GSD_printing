      ...
      <Row>
        <Col md="6" sm="12">
          ...
          >
            {listArr1.map((item) => {
              return (
                <ListGroupItem className="draggable" style={{ marginBottom: '5px' }} key={item.id}>
                    ...
                    <div>
                      ...
                      <div className="d-flex justify-content-between mt-1">
                        ...
                        <div className="d-flex align-items-end">
                          <Badge className="text-capitalize ms-1" color="light-success" pill>
                            low
                          </Badge>
                          <Badge className="text-capitalize ms-1" color="light-warning" pill>
                            medium
                          </Badge>
                          <Badge className="text-capitalize ms-1" color="light-danger" pill>
                            high
                          </Badge>
                        </div>
                      </div>
