...
import { fetchSingleClientAction, editClientAction, uploadAvatarAction } from '../store/actions';
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-75">
                  ...
                  <span>
                    ...
                    {selectedUser?.companyAddress?.zipCode} {selectedUser?.companyAddress?.state}{' '}
            ...
            <Row className="gy-1 pt-75">
              ...
              <Col md={6} xs={12}>
                ...
                <Select
                  ...
                  defaultValue={{
                    ...
                    label: contact?.gender?.charAt(0)?.toUpperCase() + contact?.gender?.substring(1)
                  }}
                />
              </Col>
              <Col md={6} xs={12}>
              ...
              <Col md={6} xs={12}>
                ...
                <Select
                  ...
                  defaultValue={{
                    value: contact?.type,
                    label: contact?.type?.charAt(0)?.toUpperCase() + contact?.type?.substring(1)
                  }}
                />
              </Col>
              ...
              <Col md={6} xs={12}>
                ...
                <Select
                  ...
                  defaultValue={{
                    ...
                    label:
                      contact?.position?.charAt(0)?.toUpperCase() + contact?.position?.substring(1)
                  }}
                />
              </Col>
              <Col md={6} xs={12}>
              ...
              <Col xs={12} className="text-center mt-2 pt-50">
                ...
                >
                  {isClientContactLoading ? 'Processing...' : 'Submit'}
                </Button>
                <Button
                  type="reset"
                  color="secondary"
