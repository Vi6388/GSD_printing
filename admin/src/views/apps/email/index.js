              ...
              >
                <div className="d-flex flex-row justify-content-between px-2 pt-0">
                  ...
                  {editOrAddOrListTemplate === 'list' && activeFolder !== null && (
                    <div className="pt-1">
                      <Button onClick={MakeActionOnTemplate}>{'Add Automation'}</Button>
                      <Modal isOpen={open} toggle={toggle} centered={true} style={{ zIndex: 1 }}>
                        <ModalHeader toggle={toggle}>Add Automation</ModalHeader>
                        <ModalBody>
                          <div className="">
                            <div>
                              <Row>
                ...
                <Fragment>
                  <div style={{ overflow: 'hidden' }}>
                    {mailsTODisplay?.length > 0 ? (
                      <AutomationGraph setEditOrAddOrListTemplate={setEditOrAddOrListTemplate} />
                    ) : !activeFolder ? (
