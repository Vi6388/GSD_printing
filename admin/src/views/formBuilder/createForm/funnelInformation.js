    ...
    <div id="funnelinformation" className="m-4 from-stepper">
      ...
      <Row>
        <Col item sm={12} md={2} lg={2}>
          <Card
            className={`funnelType ${formType === 'optin' ? 'active' : ''}`}
            onClick={() => setFormType('optin')}
          >
            <TbFilter size={50} />
        ...
        <Col item sm={12} md={2} lg={2}>
          <Card
            className={`funnelType ${formType === 'sales' ? 'active' : ''}`}
        ...
        <Col item sm={12} md={2} lg={2}>
          <Card
            className={`funnelType ${formType === 'webinar' ? 'active' : ''}`}
            onClick={() => setFormType('webinar')}
          >
            <TbView360 size={50} />
        ...
        <Col item sm={12} md={2} lg={2}>
          <Card
            className={`funnelType ${formType === 'forms' ? 'active' : ''}`}
            onClick={() => setFormType('forms')}
          >
            <TbForms size={50} />
