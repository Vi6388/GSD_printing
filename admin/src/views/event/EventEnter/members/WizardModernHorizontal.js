...
const WizardModernHorizontal = ({ toggle, event, registrantType, refetchRegistrantData }) => {
  // ** State
  const [stepper, setStepper] = useState(null);
  const [payload, setPayload] = useState({ registrantType: registrantType, eventId: event._id });
