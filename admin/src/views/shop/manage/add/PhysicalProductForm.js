      ...
      <Form>
        <Row>
          ...
          <Col md="6" sm="12" className="mb-1">
            ...
            <Input type="number" name="totalPrice" id="totalPrice" placeholder="Total Price" />
          </Col>
          ...
          <Col md="6" sm="12" className="mb-1">
            ...
            <Input type="number" name="paynow" id="paynow" placeholder="Write an amount to pay" />
          </Col>
          <Col md="6" sm="12" className="mb-1">
            <Label className="form-label" for="payLater">
              Pay Later
            </Label>
            <Input type="number" name="payLater" id="payLater" placeholder="Pay Later" />
          </Col>
          <Col md="6" sm="12" className="mb-1">
