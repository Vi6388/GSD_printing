...
const CoursesHeader = (props) => {
  // ** Props
  const { activeView, setActiveView, filteredCourses, setSidebarOpen } = props;
        ...
        <Col sm="12">
          <div className="ecommerce-header-items">
            <div className="result-toggler">
              ...
              <span className="search-results">{filteredCourses?.length} Results Found</span>
            </div>
            <div className="view-options d-flex">
              {/* <UncontrolledButtonDropdown className="dropdown-sort">
                ...
                <DropdownMenu>
                  <DropdownItem className="w-100">Featured</DropdownItem>
                  <DropdownItem className="w-100">Lowest</DropdownItem>
                  <DropdownItem className="w-100">Highest</DropdownItem>
                </DropdownMenu>
              </UncontrolledButtonDropdown> */}
              <ButtonGroup>
                <Button
