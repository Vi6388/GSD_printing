...
const CourseDetails = (props) => {
  // ** Props
  const { activeCourse: details, courseId, courseList } = props;
  ...
  useEffect(() => {
    dispatch(activeCourseLessonsFetchAction(courseId));
            ...
            <Row>
              <Col xl="9">
                <div className="d-flex justify-content-start mb-2">
                  <img className="img-fluid " src={details?.courseImage} />
                </div>
              ...
              <Col xl="3" className="bg-light-secondary">
                <PerfectScrollbar>
