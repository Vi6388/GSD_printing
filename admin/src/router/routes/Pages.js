...
const PagesRoutes = [
  {
    path: '/home',
    component: lazy(() => import('../../views/pages/authentication/Home')),
    layout: 'BlankLayout',
    meta: {
      authRoute: true
    }
  ...
  {
    path: '/newPage',
    component: lazy(() => import('../../views/event/Newpage')),
    layout: 'BlankLayout',
    meta: {
      publicRoute: true
    }
  ...
  {
    path: '/divisionsheet',
    component: lazy(() => import('../../views/event/Bracketing/DivisionSheet')),
    layout: 'BlankLayout',
    meta: {
      publicRoute: true
    }
  ...
  {
    path: '/blackbeltcreativeform',
    component: lazy(() => import('../../views/event/BlackbeltCreativeForm')),
    layout: 'BlankLayout',
    meta: {
      publicRoute: true
    }
